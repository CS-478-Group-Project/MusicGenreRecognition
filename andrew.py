...
class Andrew:
    ...
    def __str__(self):
        return "Tempo, Total beats, Average beats, MFCC mean, MFCC std, MFCC variance, " \
                "MFCC delta mean, MFCC delta std, MFCC delta variance, " \
    ...
    """
    def MFCC(self):
        mfcc = librosa.feature.mfcc(y=self.section, sr=self.sr)
    ...
    def Chroma(self):
        chroma_stft = librosa.feature.chroma_stft(y=self.section, sr=self.sr)
